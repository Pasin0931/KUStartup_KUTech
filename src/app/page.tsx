        ...
        <>
            ...
            <div className="flex flex-col items-center h-screen w-full overflow-y-auto py-17">
                <motion.div
                    ...
                    className="bg-[#241C4F] flex flex-col justify-center items-center object-cover border-8 border-[#3A3690] rounded-3xl p-8 gap-6 sm:w-60 md:w-200 lg:w-200 shadow-2xl text-white"
                >
                    ...
                    <h1 className="font-bold text-3xl bg-gradient-to-r from-[#E8B98C] via-[#8C7FBE] to-[#8CC5B8] bg-clip-text text-transparent">Startup 101 2026</h1>

                    <div className="bg-[#3A3690] w-full h-[3px] rounded rounded-100"></div>
                    ...
                    {pageState === "participant" ? (
                        <>
                            ...
                            <div className="w-full">
                                ...
                                >
                                    <ComboboxInput
                                        placeholder="Select your mentor name"
                                        className="[&_input]:placeholder:text-white/70"
                                    />
                                    <ComboboxContent>
                            ...
                            <div className="w-full">
                                ...
                                >
                                    <ComboboxInput
                                        placeholder="Select your participant name"
                                        className="[&_input]:placeholder:text-white/70"
                                    />
                                    <ComboboxContent>
                                        <ComboboxEmpty>No items found.</ComboboxEmpty>
                            ...
                            {thisMentor.trim() !== '' && thisParName.trim() !== '' && thisAttendance.trim() !== '' && thisSession.trim() !== '' &&
                                thisMentor.trim() !== '---' && thisParName.trim() !== '---' && thisAttendance.trim() !== '---' && thisSession.trim() !== '---' && (
                                    ...
                                    >
                                        <div className="bg-[#3A3690] w-full h-[3px] rounded rounded-100 mb-9"></div>
                                        ...
                                        <div className="mt-6">
                                            <div className="flex flex-col justify-cemter items-center pb-2">
                                                ...
                                                <p className="text-[#FF9F9F]">(* สำหรับพิมพ์ประเมินผลงาน สิ่งที่ทำได้ดี และสิ่งที่ควรพัฒนา)</p>
                                            </div>
                                        ...
                                        <div className="mt-6">
                                            <div className="flex flex-col justify-cemter items-center pb-2">
                                                ...
                                                <p className="text-[#FF9F9F]">(* สำหรับประเมินพฤติกรรมในคลาส)</p>
                                            </div>
                                        ...
                                        {asst1 !== null && asst2 !== null && asst3 !== null && feedback.trim() !== '' && bhFeedBack.trim() !== '' && (
                                            ...
                                            >
                                                <Button onClick={() => handle_submit()} className='w-40 h-10 mt-6 bg-gradient-to-br from-[#E8B98C] via-[#8C7FBE] to-[#8CC5B8] text-[#241C4F]'>Submit Form</Button>
                                            </motion.div>
                                        )}
                        ...
                        <>
                            <div className="w-full">
                                <div className="bg-[#3A3690] w-full h-[3px] rounded rounded-100 mb-6"></div>
                                <h2 className="flex flex-col justify-center items-center pb-6 font-bold">All fills are required in order to submit</h2>
                            ...
                            <div className="w-full">
                                ...
                                >
                                    <ComboboxInput
                                        placeholder="Select other mentor name"
                                        className="[&_input]:placeholder:text-white/70"
                                    />
                                    <ComboboxContent>
                                        <ComboboxEmpty>No items found.</ComboboxEmpty>
                            ...
                            <div className="">
                                <div className="flex flex-col justify-cemter items-center pb-2">
                                    ...
                                    <p className="text-[#FF9F9F]">(* สำหรับพิมพ์ประเมินผลงาน สิ่งที่ทำได้ดี และสิ่งที่ควรพัฒนา สําหรับเพื่อน Mentor)</p>
                                </div>
                            ...
                            {mentorName1.trim() !== '' && mentorName2.trim() !== '' && feedbackMentor.trim() !== '' && mentorName1.trim() !== '---' && mentorName2.trim() !== '---' && (
                                <motion.div
                                    ...
                                    className="flex flex-col items-center justify-center"
                                >
                                    <Button onClick={() => handle_mentor_submit()} className='w-40 h-10 bg-gradient-to-br from-[#E8B98C] via-[#8C7FBE] to-[#8CC5B8] text-[#241C4F]'>Submit Form</Button>
                                </motion.div>
                            )}
                        </>
                    )}
